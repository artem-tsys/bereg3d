...
const paths = {
    root: './wp-content/themes/bereg',
    templates: {
        pages: ['./src/pug/pages/*.pug','./src/pug/pages/includes/*.pug'],
        src: './src/pug/**/*.pug',
        dest: './wp-content/themes/bereg'
    },
    styles: {
        main: './src/assets/s3d/styles/main.scss',
        src: './src/assets/s3d/styles/**/*.scss',
        dest: './wp-content/themes/bereg/assets/s3d/styles'
    },
    scripts: {
        src: './src/assets/s3d/scripts/**/*.js',
        dest: './wp-content/themes/bereg/assets/s3d/scripts/'
    },
    fonts: {
        src: './src/assets/fonts/**/*',
        dest: './wp-content/themes/bereg/assets/fonts'
    },
    images: {
        src: './src/assets/s3d/images/**/*',
        dest: './wp-content/themes/bereg/assets/s3d/images'
    },
    svgSprite: {
    ...
    static: {
        src: './src/static/**/*.*',
        dest: './wp-content/themes/bereg/static/'
    },

	json: {
		src: './src/assets/s3d/*.json',
		dest: './wp-content/themes/bereg/assets/s3d/'
	},
};
